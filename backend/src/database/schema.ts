...
export const employeeTransactions = pgTable('employee_transactions', {
  ...
  type: employeeTransactionType('type').notNull(), currency: text('currency').notNull(), amount: numeric('amount', { precision: 18, scale: 4 }).notNull(), exchangeRateSypPerUsd: numeric('exchange_rate_syp_per_usd', { precision: 18, scale: 4 }).notNull().default('1'), advanceDeductionAmount: numeric('advance_deduction_amount', { precision: 18, scale: 4 }).notNull().default('0'),
...
// A purchase may be ready-made new stock, or loose/used gold ("خاشر") awaiting a
// manager decision.  The latter is deliberately kept out of sellable inventory.
export const purchaseMaterialType = pgEnum('purchase_material_type', ['new', 'scrap']);
...
export const goldTransactionType = pgEnum('gold_transaction_type', ['opening', 'sale_exchange', 'sales_return_obligation', 'purchase_settlement', 'purchase_return_adjustment', 'receipt', 'payment', 'conversion', 'reversal', 'used_inventory_conversion', 'purchase_scrap']);
...
export const purchaseInvoices = pgTable('purchase_invoices', {
  ...
  materialType: purchaseMaterialType('material_type').notNull().default('new'), goldSubtotalUsd: numeric('gold_subtotal_usd', { precision: 18, scale: 4 }).notNull().default('0'), workmanshipSubtotalUsd: numeric('workmanship_subtotal_usd', { precision: 18, scale: 4 }).notNull().default('0'), discountUsd: numeric('discount_usd', { precision: 18, scale: 4 }).notNull().default('0'), finalTotalUsd: numeric('final_total_usd', { precision: 18, scale: 4 }).notNull().default('0'), finalTotalSyp: numeric('final_total_syp', { precision: 20, scale: 2 }).notNull().default('0'), paidUsd: numeric('paid_usd', { precision: 18, scale: 4 }).notNull().default('0'), paidSyp: numeric('paid_syp', { precision: 20, scale: 2 }).notNull().default('0'), paidSypInUsd: numeric('paid_syp_in_usd', { precision: 18, scale: 4 }).notNull().default('0'), remainingDebtUsd: numeric('remaining_debt_usd', { precision: 18, scale: 4 }).notNull().default('0'),
