...
@Module({ imports: [AuthModule, PermissionsModule, WarehousesModule, AuditModule, RealtimeModule, FinanceModule, AccountingModule], controllers: [SalesController], providers: [SalesService] })
